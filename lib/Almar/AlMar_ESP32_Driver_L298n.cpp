...
AlMar::Esp32::Driver_L298n::Driver_L298n(int pin_en,int pin_m1,int pin_m2,uint32_t pwm_freq) {
    pinEN=pin_en;
    pinM1=pin_m1;
    pinM2=pin_m2;
    pwmFreq=pwm_freq;
    ...
    Serial.printf("Initializing GPIO for unit %d, chann %d, pen=%d, pin1:%d, pin2:%d\n",(int) mcpwm_Unit,(int) mcpwm_Chann,pinEN,pinM1,pinM2);
