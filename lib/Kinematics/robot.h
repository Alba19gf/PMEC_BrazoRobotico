...
public:
   ...
   // void MovRobot(float x_inicio, float y_inicio, float x_fin, float y_fin, float L1, float L2, float L3);
    ...
    float** arrayTlineal(float x_inicio, float y_inicio, float z_inicio, float x_fin, float y_fin, float z_fin, float L1, float L2, float L3);
    float** arrayTelipse(float x_inicio, float y_inicio, float x_fin, float y_fin, float L1, float L2, float L3);
};
